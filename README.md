...
```javascript
names = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-female-first-names-en@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-female-first-names-en@umd/bundle.js"></script>
```
