...
```javascript
import names from 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-female-first-names-en@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/datasets-female-first-names-en/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/datasets-female-first-names-en/actions/workflows/test.yml?query=branch:v0.2.3
